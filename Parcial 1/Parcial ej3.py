...
def masters(list_values, criterio1, criterio2):
    print()
    for jedi in range (len(jedis)):
        if jedis[jedi]["master"] is not None:
            if criterio1 in jedis[jedi]["master"] or criterio2 in jedis[jedi]["master"]:
                print(f'Nombre: {jedis[jedi]["name"]}, Maestro: {jedis[jedi]["master"]}')


# a
print()
print('Listado olrdenado nombre/especie:')
jedis.sort(key = by_name_species)
for jedi in jedis:
...
# c
masters(jedis, "Luke Skywalker", "Yoda")
...
print('Nombres con A:')
for jedi in range (len(jedis)):
    if jedis[jedi]["name"].startswith("A"):
        print(f'   {jedis[jedi]["name"]}')


# f
print()
print('Nombres sable de luz +1 color:')
for jedi in range (len(jedis)):
...
# g
print()
print('Nombres sable de luz violeta/amarillo:')
for jedi in range (len(jedis)):
    if jedis[jedi]["lightsaber_color"] is not None:
        if "Purple" in jedis[jedi]["lightsaber_color"] or "Yellow" in jedis[jedi]["lightsaber_color"]:
            print(f'   {jedis[jedi]["name"]}')


# h
masters(jedis, "Qui-Gon Jin", "Mace Windu")


# i
print()
print('Jedis Grand Master:')
gm = search(jedis, "rank", "Grand Master")  
if gm is  not None:
    print(f'   {jedis[gm]["name"]}')
