...
class BinaryTree:
    ...
    def creatures_inorden(self):
        def __creatures_inorden(root):
            if root is not None:
                __creatures_inorden(root.left)
                print(root.value, '/' , root.other_value['Derrotado'])
                __creatures_inorden(root.right)

        if self.root is not None:
            __creatures_inorden(self.root)

    # def contar_dioses_heroes(self):
    #     def __contar_dioses_heroes(root):
    #         counter = 0
    #         counter2 = root.value
    #         if root is not None:
    ...
    #             counter+= __contar_dioses_heroes(root.left)
    #             counter += __contar_dioses_heroes(root.right)
    #         return counter

    #     return __contar_dioses_heroes(self.root)

    def inorden_heracles_derrotada(self):
        def __inorden_heracles_derrotada(root):
            if root is not None:
                __inorden_heracles_derrotada(root.left)
                if root.other_value['Derrotado'] is 'Heracles':
                    print(root.value)
                __inorden_heracles_derrotada(root.right)

        if self.root is not None:
            __inorden_heracles_derrotada(self.root)

    def inorden_no_derrotadas(self):
        def __inorden_no_derrotadas(root):
            if root is not None:
                __inorden_no_derrotadas(root.left)
                if root.other_value['Derrotado'] is None:
                    print(root.value)
    ...
    def inorden_heracles_capturada(self):
        def __inorden_heracles_capturada(root):
            if root is not None:
                __inorden_heracles_capturada(root.left)
                if root.other_value['Capturada'] is 'Heracles':
                    print(root.value)
                __inorden_heracles_capturada(root.right)

        if self.root is not None:
            __inorden_heracles_capturada(self.root)
